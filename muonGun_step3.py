...
# with command line options: step4 --conditions auto:phase1_2017_realistic -s HARVESTING:@standardValidation+@standardDQM+@ExtraHLT+@miniAODValidation+@miniAODDQM --scenario pp --filetype DQM --geometry DB:Extended --era Run2_2017 --mc --io HARVESTFull_2017.io --python HARVESTFull_2017.py -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_higgs/cmshww/calderon/monoH-2017/muons/step3_inDQM_ULTkAlign.root')
)
