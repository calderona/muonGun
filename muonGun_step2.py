...
process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:100X_mc2017_realistic_v1', '')
#process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:105X_mc2017_realistic_v5', '') 
