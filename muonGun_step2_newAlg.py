...
process.GlobalTag.toGet = cms.VPSet(
  cms.PSet(record = cms.string("TrackerAlignmentRcd"),
           tag = cms.string("TrackerAlignment_Upgrade2017_realistic_v2"), #TrackerAlignment_Upgrade2017_realistic_v3"),#TrackerAlignment_2017_ultralegacymc_v2"),
           connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
          ),
    cms.PSet(record = cms.string("TrackerAlignmentErrorExtendedRcd"),                                                                 
           tag = cms.string("TrackerAlignmentExtendedErrors_Upgrade2017_realistic_v2"),#TrackerAlignmentExtendedErrors_Upgrade2017_realistic_v2"),#TrackerAlignmentExtendedErrors_2017_ultralegacymc_v2"),                                                
           connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")                                                           
          )
)
